...
def batch_ocr_extract(pdf_path, batch_size=20):
    """Extract text from PDF using OCR in batches"""
...
if __name__ == "__main__":
    ...
    print("🔧 Batch OCR Configuration:")
    print("📦 Batch size: 20 pages (adjustable)")
    ...
    try:
        batch_size = int(input("Enter batch size (default 20, recommended 10-30): ") or "20")
    except ValueError:
        batch_size = 20
    
    print(f"\n🚀 Starting with batch size: {batch_size}")
